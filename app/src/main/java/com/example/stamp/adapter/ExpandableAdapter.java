...
public class ExpandableAdapter extends BaseExpandableListAdapter {
    ...
    private boolean isSelectAll = false;//父控件是否处于选中状态默认状态为不显示

    public ExpandableAdapter(Context context, BitmapUtils bitmap, ShopNameBean shopNameBean, boolean isEditing) {
...
//                    setSettleInfo();
                ...
                case R.id.checkbox_shopCart://子View的CheckBox点击事件
