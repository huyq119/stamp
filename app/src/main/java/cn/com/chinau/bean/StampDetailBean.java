...
public class StampDetailBean extends BaseBean{
    ...
    public ArrayList<OfferListData> offer_list;// 出价记录List
    ...
    public ArrayList<OfferListData> getOffer_list() {
        return offer_list;
    }

    public void setOffer_list(ArrayList<OfferListData> offer_list) {
