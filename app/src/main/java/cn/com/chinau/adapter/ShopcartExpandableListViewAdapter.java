...
public class ShopcartExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ShopNameBean.GoodsBean> goods_list;
    // 用来控制CheckBox的选中状况
    ...
    public View getChildView(final int i, final int i1, boolean isLastChild, View view, ViewGroup parent) {
        ...
        final ShopNameBean.GoodsBean product = (ShopNameBean.GoodsBean) getChild(i, i1);
...
/*    public interface CheckInterface {
    ...
    public interface ModifyCountInterface {
        ...
        public void doIncrease(int position, int i1, View showCountView, boolean isChecked, ArrayList<ShopNameBean.GoodsBean> goods_list);
