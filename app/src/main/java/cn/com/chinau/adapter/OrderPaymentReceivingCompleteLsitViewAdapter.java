...
public class OrderPaymentReceivingCompleteLsitViewAdapter extends BaseExpandableListAdapter{
    ...
    public OrderPaymentReceivingCompleteLsitViewAdapter(Context context, BitmapUtils bitmapUtils, List<OrderAllListViewGoodsBean.Seller_list> groups, Map<String, List<OrderAllListViewGoodsBean.Order_detail_list>> goods) {
