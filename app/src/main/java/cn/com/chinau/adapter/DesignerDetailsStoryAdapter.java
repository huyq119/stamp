 ...
 * 设计故事适配器
 */
public class DesignerDetailsStoryAdapter extends BaseAdapter{
    private ArrayList<DesignerDetailsBean.DesignerStory> list;//填入的集合
    private Context context;
    private BitmapUtils bitmap;

    public DesignerDetailsStoryAdapter(Context context, ArrayList<DesignerDetailsBean.DesignerStory> list, BitmapUtils bitmap) {
        this.list = list;
