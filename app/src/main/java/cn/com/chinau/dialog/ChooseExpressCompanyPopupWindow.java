 ...
 * （退款/退货）选择快递公司PopupWindow
 */
public class ChooseExpressCompanyPopupWindow extends PopupWindow{
     ...
     */
    public ChooseExpressCompanyPopupWindow(Context context, View.OnClickListener onClickListener) {
        super(context);

        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mPayView = inflater.inflate(R.layout.choose_express_company_popup, null);
