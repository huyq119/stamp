...
import cn.com.chinau.utils.FourCode;

/**
 * Created by Administrator on 2016/9/19.
 * 注册次数的弹框
 */
public class CountRegisterDialog extends Dialog implements View.OnClickListener {
    ...
    public CountRegisterDialog(Context context, String current, SendProgressDialog pd) {
